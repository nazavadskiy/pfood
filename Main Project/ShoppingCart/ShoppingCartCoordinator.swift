...
class ShoppingCartCoordinator: CoordinatorProtocol {
        
        let mainVC: UIViewController
        weak var hamburgerRouter: HamburgerRouterProtocol?
        
        init() {
            let rootVC = ShoppingCartViewController()
...
extension ShoppingCartCoordinator: ShoppingCartControllerDelegate {
